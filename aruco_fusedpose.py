...
def draw_render_state(
    ...
    lines = [
        "ArUco rigid object fused pose  dictionary: {}  video_fps={:.1f} process_fps={:.1f} display_fps={:.1f} tag_detect={:.1f}ms resolution={}".format(
            args.dictionary,
...
def run_image(args, dictionary, params, detector, layout, render_layout, camera_matrix, dist_coeffs):
...
def run_camera(args, dictionary, params, detector, layout, render_layout, camera_matrix, dist_coeffs):
...
def main():
    ...
    if args.image:
        run_image(args, dictionary, params, detector, layout, render_layout, camera_matrix, dist_coeffs)
    else:
        run_camera(args, dictionary, params, detector, layout, render_layout, camera_matrix, dist_coeffs)
