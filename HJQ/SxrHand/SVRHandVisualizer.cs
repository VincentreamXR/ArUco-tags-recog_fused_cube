...
public class SVRHandVisualizer : MonoBehaviour
{
        ...
        protected void Update()
        {
            ...
            /*float value = easeOutExpo((Mathf.Sin(Time.time * 2) + 1) / 2.0f, 0,1, 2);
            Color color = Color.Lerp(Color.white, Color.cyan, value);
            handRenderer.sharedMaterial.SetColor("_ColorThumb", color);
            handRenderer.sharedMaterial.SetColor("_ColorIndex", color);
            handRenderer.sharedMaterial.SetColor("_ColorMiddle", color);
            handRenderer.sharedMaterial.SetColor("_ColorRing", color);
            handRenderer.sharedMaterial.SetColor("_ColorPinky", color);
            handRenderer.sharedMaterial.SetColor("_ColorPalm", color);*/
